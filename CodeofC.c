...
// (6). Function...()
# include<stdio.h>
void riya (){ //without parameter& without Returntype
printf("this is frist function\n");
}
void riya1( int roll){ //with parameter& without Returntype
printf("this is second function\n");
printf("My roll number is %d\n",roll);
}
int riya2 (int a,int b){ //with parameter& with Returntype
printf("this is third function\n");
printf("My sum is %d\n",a+b);
}
int riya3 (){ //without parameter& with Returntype
